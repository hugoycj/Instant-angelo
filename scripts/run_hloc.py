...
def main(data_dir, match_type):
    ...
    if match_type == 'exhaustive':
        ...
        reconstruction.main(sfm_dir, images, sfm_pairs, features, matches, image_list=references, camera_mode=pycolmap.CameraMode.SINGLE, image_options={'camera_model': 'OPENCV'})
    else:
        ...
        reconstruction.main(sfm_dir, images, sfm_pairs, feature_path, match_path, camera_mode=pycolmap.CameraMode.SINGLE, image_options={'camera_model': 'OPENCV'})
